Public Class frmAbout
    Private Sub frmAbout_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ComboBox1.Items.Add("V1.5.8.0（当前版本）")
        ComboBox1.Items.Add("V1.5.7.0")
        ComboBox1.Items.Add("V1.5.6.0")
        ...
        ComboBox1.Text = "V1.5.8.0（当前版本）"
        Label4.Text = Chr(34) & "推广界面" & Chr(34) & "大小与图片大小保持相同并禁止缩放；修复" & Chr(34) & "启动界面" & Chr(34) & "状态文字显示不全的问题；修复" & Chr(34) & "关于界面" & Chr(34) & "版本号显示异常的问题。"
    End Sub
    Private Sub ComboBox1_TextChanged(sender As Object, e As EventArgs) Handles ComboBox1.TextChanged
        If ComboBox1.Text = "V1.5.8.0（当前版本）" Then
            Label4.Text = Chr(34) & "推广界面" & Chr(34) & "大小与图片大小保持相同并禁止缩放；修复" & Chr(34) & "启动界面" & Chr(34) & "状态文字显示不全的问题；修复" & Chr(34) & "关于界面" & Chr(34) & "版本号显示异常的问题。"
        ElseIf ComboBox1.Text = "V1.5.7.0" Then
            Label4.Text = "恢复程序内更新，由服务器迁移至" & Chr(34) & "Github" & Chr(34) & "（可能加载较慢易造成程序卡顿）；" & Chr(34) & "启动界面" & Chr(34) & "新增延迟功能，程序自检流程更直观；针对程序更新和公告信息分开进行处理；获得授权推广" & Chr(34) & "晨钟酱" & Chr(34) & "的全机型免ROOT玩机工具箱——《GJ2x_搞机工具箱》。"
        ElseIf ComboBox1.Text = "V1.5.6.0" Then
