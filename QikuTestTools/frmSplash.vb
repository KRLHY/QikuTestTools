Public Class frmSplash
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        frmExecute.Text = "QikuTestTools V" & Application.ProductVersion
        ...
        End If
        If System.IO.File.Exists(s & "/tmp/notice.txt") Then
            System.IO.File.Delete(s & "/tmp/notice.txt")
        End If
        Form1.Delay(1200)
        ...
        m = Process.Start("cmd.exe", "/c title QikuTestTools && echo QikuTestTools正在执行一些代码，请不要关闭该界面并耐心等待一段时间，该界面会自动在代码执行完成后消失...... &&" & Mid(Application.StartupPath, 1, 2) & "&& icacls " & Chr(34) & Application.StartupPath & "\tmp" & Chr(34) & " /t /grant:r everyone:f > " & Chr(34) & "C:\Users\Public\Downloads\temporary0.txt" & Chr(34))
        Application.DoEvents()
        m.WaitForExit()
        ...
        If n = 0 Then
            ...
            End
        End If
        Label1.Text = "QikuTestTools正在联网检查程序更新和公告信息......"
        If System.IO.File.Exists(s & "/tmp/update.txt") Then
            System.IO.File.Delete(s & "/tmp/update.txt")
        End If
        If System.IO.File.Exists(s & "/tmp/notice.txt") Then
        ...
        Try
            Application.DoEvents()
            My.Computer.Network.DownloadFile("https://krlhy.github.io/QikuTestTools/11.txt", s & "/tmp/update.txt")
        Catch
            u = False
        End Try
        Dim b As String
        ...
        Try
            Application.DoEvents()
            My.Computer.Network.DownloadFile("https://krlhy.github.io/QikuTestTools/12.txt", s & "/tmp/notice.txt")
        Catch
            u = False
        End Try
        Dim c As String
        ...
        c = ""
        If u Then
            file = New System.IO.StreamReader(s & "/tmp/notice.txt")
            a = file.ReadLine()
